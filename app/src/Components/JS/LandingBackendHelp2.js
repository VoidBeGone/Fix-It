export default function serviceQuery(someuserid, setSearchResults){
    ...
    const dummyJobs = [
            { id: 1, title: "Fix leaky faucet", client: "John Doe", stage: "Payment In Progress", date: "2023-10-01", type: "Plumbing", location: "Toronto" },
            ...
            { id: 5, title: "Replace water heater", client: "Michael Davis", stage: "Payment In Progress", date: "2023-10-12", type: "Plumbing", location: "Toronto" },
    ];
    return;
}