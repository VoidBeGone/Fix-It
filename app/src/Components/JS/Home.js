...
function Home({ authentication,backhome,setSearched,setSearchValue, setterAddress}) {
  ...
  const handleSearch = (event) => {
    ...
    console.log("Hello");
    setSearched();
    setSearchValue(event.target.service.value);
    setterAddress(event.target.address.value);
  };
